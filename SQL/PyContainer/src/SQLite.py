...
projectIDb = None
try:
    projectIDb = sqlite3.connect(
        database= "./sqlite_ProjectI.db"
    )   
    print("DB ready\n")
...
def sqlInsert(Question : str, AList : list[int], RIndex : int):
    ...
    query = "INSERT INTO Questions(Question, RightAnswer, WrongAnswer1, WrongAnswer2, WrongAnswer3, QLevel)VALUES(?, ?, ?, ?, ?, ?);"
    selections = [0,1,2,3]
